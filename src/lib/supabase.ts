...
if (!supabaseUrl) {
    throw new Error('supabaseUrl is required. Set EXPO_PUBLIC_SUPABASE_URL or SUPABASE_URL.');
}

if (!supabaseAnonKey) {
    throw new Error('supabaseAnonKey is required. Set EXPO_PUBLIC_SUPABASE_ANON_KEY or SUPABASE_ANON_KEY.');
}
